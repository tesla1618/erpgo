                                        ...
                                        <div class="col-lg-4 col-xl-4 col-md-4">
                                            ...
                                            <div class="color-wrp">
                                                ...
                                                <div class="color-picker-wrp ">
                                                        <input type="color" value="<?php echo e($color ? $color : ''); ?>" class="colorPicker <?php echo e(isset($settings['color_flag']) && $setting['color_flag'] == 'true' ? 'active_color' : ''); ?>" name="custom_color" id="color-picker">                                             
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" name="ai_chatgpt_enable" id="ai_chatgpt_enable" data-toggle="switchbutton"
                                                   data-onstyle="primary"  <?php echo e($settings['ai_chatgpt_enable'] == 'on' ? 'checked' : ''); ?> required >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tesla/Desktop/ERP/main-file/resources/views/settings/company.blade.php ENDPATH**/ ?>