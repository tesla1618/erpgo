            ...
            <p><?php echo ($message == null && $attachment != null && @$attachment[2] != 'file') ? $attachment[1] : nl2br($message); ?>
                ...
                <?php if(@$attachment[2] == 'file'): ?>
                    <a href="<?php echo e(route(config('chatify.attachments.download_route_name'),['fileName'=>$attachment[0]])); ?>" style="color: #595959;" class="file-download">
                        <span class="ti ti-file"></span> <?php echo e($attachment[1]); ?></a>
                <?php endif; ?>
            </p>
        </div>
    ...
    <div class="message-card mc-sender" data-id="<?php echo e($id); ?>">
        <p><?php echo ($message == null && $attachment != null && @$attachment[2] != 'file') ? $attachment[1] : nl2br($message); ?>
            ...
            <sub title="<?php echo e($fullTime); ?>" class="message-time">
                <span class="ti ti-<?php echo e($seen > 0 ? 'check-double' : 'check'); ?> seen"></span> <?php echo e($time); ?></sub>
    ...
    <?php if(@$attachment[2] == 'image'): ?>
        <div>
            <div class="message-card mc-sender">
                <div class="image-file chat-image" style="width: 250px; height: 150px;background-image: url('<?php echo e(\App\Models\Utility::get_file(config('chatify.attachments.folder').'/'.$attachment[0])); ?>')">
                </div>
            </div>
        </div>
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/tesla/Desktop/ERP/main-file/resources/views/vendor/Chatify/layouts/messageCard.blade.php ENDPATH**/ ?>